...
if choice == sidebar_choice[0]:
    ...
    with colB2:
        add_edit_bar('drawing_number', 'Numer rysunku', 'text', r'%.1f', '1')            
        add_edit_bar('name', 'Nazwa', 'text', r'%.1f', '2')           
        add_edit_bar('height_before_bending', 'Długość', 'number', r'%.1f', '3')
        add_edit_bar('width_before_bending', 'Szerokość', 'number', r'%.1f', '4')
        add_edit_bar('thickness', 'Grubość', 'number', r'%.1f', '5')
        add_edit_bar('number_of_bends', 'Ilość gięć', 'number', r'%.1f', '6')
        add_edit_bar('bending_radius', 'Promień gięcia', 'number', r'%.1f', '7')

    with colB3:
        add_edit_bar('material', 'Materiał', 'text', r'%.1f', '8')            
        add_edit_bar('mass', 'Waga', 'text', r'%.1f', '9')           
        add_edit_bar('model', 'Model', 'number', r'%.1f', '10')
        add_edit_bar('pattern', 'Wykrój', 'number', r'%.1f', '11')
        add_edit_bar('drawing', 'Rysunek', 'number', r'%.1f', '12')
        add_edit_bar('nums_of_corr', 'Numer poprawki', 'number', r'%.1f', '13')
        add_edit_bar('additional_note', 'Uwagi', 'text ', r'%.1f', '14')
